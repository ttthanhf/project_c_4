...
void main_calendar()
{
  ...
  gtk_fixed_put(GTK_FIXED(fixed_window), button_add_event, 1300, 250);
  gtk_fixed_put(GTK_FIXED(fixed_window), button_delete_event, 1300, 300);
  gtk_fixed_put(GTK_FIXED(fixed_window), button_event_list, 1300, 350);
...
// gcc `pkg-config --cflags gtk+-3.0` -o app gtk_testtt.c `pkg-config --libs gtk+-3.0`
// ./app
